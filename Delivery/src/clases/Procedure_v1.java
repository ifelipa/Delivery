...
public class Procedure_v1 {
	int code;
	String name;

	public Procedure_v1(int code, String name) {
		this.code = code;
		this.name = name;
	}
	 ...
	 * 
	 */
	public String ProceedIngredient(int codeProcedure, Ingredient_v1 codeIngredient, int quantity, int times, int time,
			int temperature) {
